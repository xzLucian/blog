import { NavLink } from "../.vitepress/theme/types/NavLink"
...
export const NAV_DATA: NavData[] = [
  {
    ...
    items: [
      ...
      {
        icon: '/icons/fagedongxi.png',
        title: '发个东西',
        desc: '局域网文字/文件P2P传输工具',
        link: 'https://fagedongxi.com/',
      },
      {
        icon: 'https://transfonter.org/favicon.ico',
        title: 'transfonter',
        desc: 'Modern and simple css @font-face generator',
        link: 'https://transfonter.org/',
      },
      {
        icon: '/icons/coverbox.png',
        title: 'CoverBox',
        desc: '专辑封面工具',
        link: 'http://coverbox.henry-hu.com/list',
      },
      {
        icon: 'https://cdn.sjjzm.com/favicon.ico',
        title: 'MSDN',
        desc: 'MSDN - 山己几子木 Windows镜像',
        link: 'https://msdn.sjjzm.com/',
      },
      {
        icon: 'https://macwk.cn/wp-content/uploads/2023/07/macwkico.png',
        title: 'MacWk',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: 'Ollama',
        desc: 'Chat & build with open models',
      ...
      {
        icon:'https://docs.langchain.com/mintlify-assets/_mintlify/favicons/langchain-5e9cc07a/6qGJdyFkFFvLiKlZ/_generated/favicon/apple-touch-icon.png',
        title:'LangChain',
        desc:'LangChain overview - Docs by LangChain',
        link:'https://docs.langchain.com/'
      },
      {
        icon:'https://www.closeai-asia.com/favicon.ico',
        title:'CloseAI',
        desc:'企业级 AI 代理，为专业客户提供商用级OpenAI代理服务',
        link:'https://www.closeai-asia.com/'
      },
      {
        icon:'https://lf-coze-web-cdn.coze.cn/obj/coze-web-cn/obric/coze/favicon.1970.png',
        title:'扣子',
        desc:'扣子，用  Agent 重塑生产力',
        link:'https://www.coze.cn/'
      },
      {
        icon:'https://www.dify-china.com/favicon.ico',
        title:'Dify_',
        desc:'Dify运用智能化流程自动化与数据管理技术，帮助企业优化业务流程、提高工作效率，为多行业场景提供可靠的AI解决方案，助力数字化转型升级。',
        link:'https://www.dify-china.com/'
      }
    ]
  },
  {
    ...
    items: [
      {
        icon: '/icons/huggingface.svg',
        title: 'HF-Mirror',
        desc: 'Hugging Face 镜像网站',
        link: 'https://hf-mirror.com/'
      },
      {
        icon:'https://mirrors.tuna.tsinghua.edu.cn/static/img/favicon.png',
        title:'清华大学开源软件镜像站',
        desc:'致力于为国内和校内用户提供高质量的开源软件镜像',
        link:'https://mirrors.tuna.tsinghua.edu.cn/'
      },
      {
        icon:'http://mirrors.pku.edu.cn/static/favicon.ico',
        title:'北京大学开源镜像站',
        desc:'开源软件镜像',
        link:'https://mirrors.tuna.tsinghua.edu.cn/'
      },
      {
        icon:'http://mirrors.hust.edu.cn/img/favicon.png',
        title:'华中科技大学开源镜像站',
        desc:'HUST Mirror',
        link:'http://mirrors.hust.edu.cn/'
      },
      {
        icon:'https://img.alicdn.com/tfs/TB1_ZXuNcfpK1RjSZFOXXa6nFXa-32-32.ico',
        title:'阿里巴巴开源镜像站',
    ...
    items: [
      {
        ...
        title: '微信公众号',
        desc: '微信公众平台',
        link: 'https://mp.weixin.qq.com/?token=&lang=zh_CN',
      },
      {
        icon: 'https://res.wx.qq.com/a/wx_fed/assets/res/OTE0YTAw.png',
        title: '微信小程序文档',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: 'https://turborepo.com/favicon.ico?favicon.fb1a054d.ico',
        title: 'Turbo',
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: 'https://miao101.com/fs/static/logo.png',
        title: '旋风视频',
        link: 'https://miao101.com/',
      },
      {
        icon: 'https://www.agedm.io/favicon.ico',
        title: 'AGE动漫',
        link: 'https://www.agedm.io/',
      },
      {
        icon: 'https://vpic.cms.qq.com/nj_vpic/3272248629/1738571699548996690/3635677961821188660',
        title: '555电影',
        link: 'https://www.gv83dmbo.shop/index/home.html',
      },
      {
        icon: 'https://nkvlog.com/upload/site/20241223-1/a9ca623af581c93ed3c2f3e98e3a5d4b.png',
        title: '耐看vlog',
        link: 'https://nkvlog.com/',
      },
      {
